      ...
      <div className="max-w-2xl mx-auto text-center">
        <Card className="p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <LinkButton size="lg" href="/products">
              <Package className="w-5 h-5 mr-2" />
              Ver Todos los Productos
            </LinkButton>

            <LinkButton variant="outline" size="lg" href="/">
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <LinkButton variant="outline" size="sm" href="/products?category=jackets">
                Chaquetas
              </LinkButton>
              <LinkButton variant="outline" size="sm" href="/products?category=hoodies">
                Hoodies
              </LinkButton>
              <LinkButton variant="outline" size="sm" href="/products?category=t-shirts">
                Camisetas
              </LinkButton>
              <LinkButton variant="outline" size="sm" href="/products?category=accessories">
                Accesorios
              </LinkButton>
            </div>
          </div>
